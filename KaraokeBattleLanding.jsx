          ...
          <div>
            ...
            <Reveal delay={120}>
              <h1 className="mt-6 text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.02] text-white" style={{ fontFamily: brand.serif }}>
                Очередной <em className="italic text-white/40">скучный</em><br />
                сбор денег? <GradientText>Нет.</GradientText><br />
                Ваш голос <br className="hidden md:block" />спасает детей.
              </h1>
            </Reveal>
            <Reveal delay={240}>
              <p className="mt-6 md:mt-8 text-lg text-white/70 max-w-xl leading-relaxed">
                Первый благотворительный караоке-баттл в Казани. Один вечер. Один микрофон.
                <span className="text-white"> 100% прибыли</span> направляется в фонд{" "}
